            ...
            if restore.lower() == "y":
                ...
                while True:
                    ...
                    if not users_file_path:
                        break  # Exit the loop if the user presses enter (no custom wordlist)
                    try:
                ...
                while True:
                    passwords_file_path = input("\nEnter path/name of the passwords wordlist (Press Enter to exit) > ")
...
def dbust():
    try:
        ...
        while True:
            custom_wordlist = input("Custom wordlist (Press enter for default): ")
            if custom_wordlist == "":
